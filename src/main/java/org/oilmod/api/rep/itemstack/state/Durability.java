...
public class Durability {
    public final static StateImplementationResolver<DurabilityHelper, ItemStackStateRep> RESOLVER = new StateImplementationResolver<>(ItemStackFactory.getStateCollector(), new DurabilityHelper[]{});
