...
public class Inventory {
    public final static StateImplementationResolver<InventoryHelper, ItemStackStateRep> RESOLVER = new StateImplementationResolver<>(ItemStackFactory.getStateCollector(), new InventoryHelper[]{});
